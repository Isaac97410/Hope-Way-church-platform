      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isLoading ? (
          <div className="flex justify-center py-24">
            <LucideIcons.Loader2 className="animate-spin text-hope-gold w-10 h-10" />
          </div>
        ) : (
            ...
            {ministries?.map((ministry: any, index: number) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -5 }}
                  className="p-8 sketchy-border hard-shadow flex flex-col h-full bg-white"
                >
                  <div
                    className={cn(
                  ...
                  <Button className="w-full bg-hope-blue text-white font-bold sketchy-border-sm hard-shadow-sm hover:bg-hope-blue/90 transition-all">
                    Join Ministry
                  </Button>
                </motion.div>
              );
